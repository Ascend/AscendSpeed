...
def generate_ascendspeed_weights(tp_size, pp_size, model_type, output_model_dir, make_vocab_size_divisible_by):
        ...
        for pp_rank in range(pp_size):
            ...
            if pp_rank == pp_size - 1:
                ...
                rank_model["lm_head.lm_head.weight"] = row_split(
                    pad_embed(get_weight_from_name("lm_head.weight"), make_vocab_size_divisible_by, tp_size), tp_size,
                    tp_rank)
    ...
    print("=" * 100)
    print(f"llama {model_type} weight has been converted to ascendspeed format which stored in {output_model_dir}")
    print("=" * 100)


if __name__ == '__main__':
    make_ascendspeed_model_dirs(args.output_model_dir)
    generate_ascendspeed_weights(args.tensor_model_parallel_size, args.pipeline_model_parallel_size, args.type,
                                 args.output_model_dir, args.make_vocab_size_divisible_by)
