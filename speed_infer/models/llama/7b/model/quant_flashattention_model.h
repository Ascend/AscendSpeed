 ...
 */
#ifndef ATB_SPEED_MODELS_LLAMA_7B_QUANT_FLASHATTENTION_MODEL_H
#define ATB_SPEED_MODELS_LLAMA_7B_QUANT_FLASHATTENTION_MODEL_H
#include "atb_speed/base/model.h"


namespace atb_speed {
namespace llama_7b {
class QuantFlashAttentionModel : public Model {
public:
    struct Param {
        double rmsNormEps = 0;
        int headNum = 0;
    ...
    explicit QuantFlashAttentionModel(const std::string &param);
    ~QuantFlashAttentionModel();
