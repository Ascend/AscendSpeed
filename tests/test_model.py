...
from ascendspeed import initialize_megatron, get_args, get_tokenizer, global_vars
from ascendspeed.model.fused_softmax import ScaledMaskedSoftmax, FusedScaleMaskSoftmax
from ascendspeed.model.utils import attention_mask_func
from ascendspeed.testing_utils import TestCasePlus, mockenv_context, flatten_arguments, torch_assert_equal, \
    ...
    def test_fused_layer_norm(self):
        ...
        with patch('sys.argv', flatten_arguments(command_args)):
            with mockenv_context(**self.dist_env_1_gpu):
                ...
                self.assertTrue(mfln.use_meg_ds_fused_layer_norm, "Expected model to use AscendSpeed custom cuda kernel for LayerNorm.")
