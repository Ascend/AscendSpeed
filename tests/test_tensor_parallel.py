...
from ascendspeed.testing_utils import TestCasePlus, mockenv_context, flatten_arguments, require_deepspeed, require_torch_multi_gpu
...
class MegDSTestTP(TestCasePlus):
    ...
    def infer_model(args):
        ...
        #Hack
        import ascendspeed.initialize as init
